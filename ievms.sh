...
selenium_script() {
    ...
    printf "java -jar selenium-server-standalone-3.0.1.jar -role node -hub http://10.0.1.253:4444/grid/register/ -browser browserName=firefox,maxInstances=2 -browser browserName=chrome,maxInstances=2 -browser browserName=iexplore,maxInstances=2" >$task
